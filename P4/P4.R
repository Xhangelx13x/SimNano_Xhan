...
boxplot(zona40, zona50, zona60, zona70, zona80, zona90, zona100, col=c(20,7,19, 64, 98, 53, 30), names = lbls, ylab="Longuitud de grieta", xlab="Tamaño de zona", ylim = c(1, 140))
graphics.off()